        ...
        <div>
            <div className="grid sm:px-10 lg:grid-cols-2 lg:px-20 xl:px-32">
                <div className="px-4 pt-8">
                    ...
                    <p className="mt-8 text-lg font-medium">For Feature</p>
                    <form className="mt-5 grid gap-6">
                        <div className="relative">
                            <div className="form-control">
                                <label className="label cursor-pointer">
                                    <span className="label-text">Save payment method</span>
                                    <input type="checkbox" value="yes" className="checkbox checkbox-primary" />
                                </label>
                            </div>
                        </div>
                        <div className="relative">
                            <div className="form-control">
                                <label className="label cursor-pointer">
                                    <span className="label-text">Make default</span>
