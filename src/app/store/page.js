...
const page = () => {
    return (
        <div>
            ...
            <div class="grid lg:grid-cols-2 md:grid-cols-1 gap-4 pt-6">
                ...
                <div>
                    ...
                    <div>
                        ...
                        <div class="mx-auto flex h-8  text-gray-600">
                            ...
                            <div class="flex items-center justify-center bg-gray-100 px-4 text-xs uppercase transition">1</div>
                        ...
                        <button class="w-56 mt-3 bg-gray-900 px-6 py-3 text-white transition hover:bg-gray-700">Donate $20</button>
                    </div>
                </div>
            </div>
        </div>
